...
import com.example.meuprimeirapp.databinding.ActivityTelaInicialV6Binding

class TelaInicialV6Activity : AppCompatActivity() {
    private lateinit var binding: ActivityTelaInicialV6Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityTelaInicialV6Binding.inflate(layoutInflater)
