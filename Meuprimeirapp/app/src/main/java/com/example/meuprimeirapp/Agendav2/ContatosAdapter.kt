...
import com.example.meuprimeirapp.databinding.ItemContatoBinding

class ContatosAdapter(
    val listaContatos: MutableList<ContatoV2>
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.binding.txtNomes.text = listaContatos[position].nome
